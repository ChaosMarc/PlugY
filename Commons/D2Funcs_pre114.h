...
//A8(STD,  D2Client,00000,00000,15A80,00000,00000,00000,00000,	int,		D2GetAvgChanceMonsterWillHitYou, ());//6FAB5A80
...
//A8(FAST, D2Client,00000,00000,45990,00000,00000,00000,00000,	Unit*,		D245990, (Inventory*,DWORD idItem);//6FAE5990
...
//A8(FAST, D2Client,00000,00000,869F0,00000,00000,00000,00000,	Unit*,		D2ClientGetObject, (DWORD itemNum, DWORD type));//6FB269F0
...
//A8(FAST, D2Client,B9970,B8CF0,BB0F0,00000,00000,00000,00000,	void,		D2FillRect,(DWORD x, DWORD y, DWORD Width, DWORD Height, DWORD color, DWORD transTbl));
A8(FAST, D2Client,00000,00000,00000,00000,571C0,18450,46150,790D0,  B1620,	Unit*,		D2GetCurrentNPC, ());
...
A8(FAST, D2Client,00000,00000,00000,8E480,5BA90,1CC00,4ABE0,7DC60,  B3D40,	void,		D2ReloadGambleScreen, ());
//A8(FAST, D2Client,00000,00000,00000,00000,1FEB0,5CDD0,00000,	void,		D2OpenNPCMenu, (Unit* ptNPC));//by ESI
...
A(FAST, D2Game,00000,00000,00000,9B480,34920,D1AA0,70180,941E0, ,	void,		D2OpenPandPortal, (Game* ptGame, Unit* ptChar));
...
A(FAST, D2Game,00000,00000,00000,75980,D7BD0,CD0F0,85B60,4EAD0, ,	void,		D2DiabloIA, (Game* ptGame, Unit* ptMonster, DWORD*));
...
F(FAST, Fog,	10042,10042,10042,10042,10042,10042,10042,10042,  B380,	void*,		D2FogMemAlloc, (DWORD dwMemSize, LPCSTR lpszErrFile, DWORD ErrLine, DWORD Zero));
...
C7(D2Client, D50EC, D40E4, D40F4, F5C5C, F4FC4, DC6E0, DBC48,F7034, 31146C,	DWORD,		ResnolutionX);//0x320 = 800
